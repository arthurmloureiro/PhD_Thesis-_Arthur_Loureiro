...
\EQ{}{
R_{A,B} = \frac{P(\vec{D}_{\scriptscriptstyle\text{BOSS+PLANCK+JLA}}|\sum m_{\nu} = 0.06 \text{ eV})}{P(\vec{D}_{\scriptscriptstyle\text{BOSS+PLANCK+JLA}}|\sum m_{\nu} = 0 \text{ eV}) } = 8\times 10^5
}
...
\EQ{}{
R_{w,\Lambda} = \frac{P(\vec{D}_{\text{BOSS+Planck+JLA}}|w\text{CDM})}{P(\vec{D}_{\text{BOSS+Planck+JLA}}|\Lambda\text{CDM})} = 0.67
}
...
\EQ{}{R_{w,\Lambda} = \frac{P(\vec{D}_{\text{BOSS+Planck+JLA}}|w\text{CDM})}{P(\vec{D}_{\text{BOSS+Planck+JLA}}|\Lambda\text{CDM})} = 0.67}

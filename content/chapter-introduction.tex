...
\end{equation}
The left hand side tensor, $G^{\mu\nu}$, is also known as the Einstein tensor and it describes the geometric component of Einstein's field equations.

\qquad This was the piece missing to write Einstein's field equations relating the geometry of the Universe to its energy-momentum content
\begin{equation}
G_{\mu\nu} = 8\pi GT_{\mu\nu} - g_{\mu\nu}\Lambda\, ,
...
which, for a Universe with no anisotropic stress, leads to $\Psi (\textbf{r},t) = - \Phi(\textbf{r},t)$ \citep[][p. 476]{Peacock}. Equation \eqref{Eq:Intro:Boltzmann} can now be re-written as
...
This is a general expression for the usual Poisson equation and it can be now expressed in Fourier space, using a coordinate transformation to conformal time \citep[][pages 483 and 123, respectively]{Peacock,dods}
